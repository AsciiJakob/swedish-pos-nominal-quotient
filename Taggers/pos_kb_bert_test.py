...
# pos_pipeline = pipeline("ner", model=model, tokenizer='KB/bert-base-swedish-cased-ner')
pos_pipeline = pipeline('ner', model='KB/bert-base-swedish-cased-ner', tokenizer='KB/bert-base-swedish-cased-ner', ignore_labels=[])
