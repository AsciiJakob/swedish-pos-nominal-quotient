        ...
        for file in only_files:
            if (file.startswith("computed_") and file.endswith(".json")):
                ...
                with open("output/"+model+".csv", "w", newline="") as csvfile:
                    ...
                    writer.writerow(["Fil", "ID", "Nominalkvot", "Enkel nominalkvot", "Antal tokens", "Genomsnittlig meningslängd", "Antal citattecken", "Citatkvot", "LIX", model])
